...
const fs = require("fs");
client.login("NjE2NTE5ODMyMzQyMzY0MTcx.XZQdXQ.");
const ms = require("ms");
client.on("ready", () => {
...
bot.login("NTkzMDAwODc5ODc2MDc5NjE2.XZXpxA.");
...
//////////////////////////// C O M M A N D S /////////////////////////////////////////////////////////////
  ...
  num = Math.floor(args)*10 - 10
   ...
   rows.forEach(function (rowguild) {
     let user = `<@${rowguild.userId}>` || "<:no:439399928960253964> خرج من السيرفر"
     if(!bot.users.get(rowguild.userId)) user = "<:no:439399928960253964> خرج من السيرفر"
     counter = counter + 1
  ...
  let user = `<@${row.userId}>` || "<:no:439399928960253964> خرج من السيرفر"
  if(!bot.users.get(row.userId)) user = "<:no:439399928960253964> خرج من السيرفر"
  counter = counter + 1
